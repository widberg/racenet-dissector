...
#ifndef SUB_ALLOC_HEADER_HPP
#define SUB_ALLOC_HEADER_HPP

const UINT N1=4, N2=4, N3=4, N4=(128+3-1*N1-2*N2-3*N3)/4;
const UINT UNIT_SIZE=4+2*sizeof(void*), N_INDEXES=N1+N2+N3+N4;
...
inline UINT U2B(int NU) { return UNIT_SIZE*NU; }
...
BOOL _STDCALL StartSubAllocator(int SASize)
{
	...
	StopSubAllocator();
    if ((HeapStart=new BYTE[ static_cast<DWORD> (SASize) ]) == NULL)    
		return FALSE;
